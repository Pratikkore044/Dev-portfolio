...
import PROFILE_PIC from '../../assets/images/profile11.png'
        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              >
                I am a passionate web developer with a keen interest in designing and building dynamic web applications.
              </motion.p>
              ...
              >
                {[
                  { icon: FiGithub, href: "https://github.com/Pratikkore044" },
                  { icon: FiLinkedin, href: "https://www.instagram.com/_.kpratik._/" },
                  { icon: Mail, href: "mailto:iampratikkore@gmail.com"  },
                ].map((social, index) => (
                  <motion.a
                    key={index}
                    href={social.href}
